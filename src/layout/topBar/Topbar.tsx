...
export default memo(function Topbar() {
  ...
  return (
    <TopBarWrapper className="h-[70px] bg-[#242424] flex justify-center items-center text-[#ccc]">
      <div onClick={() => navigate('/')} className="cursor-pointer w-[176px] h-[100%] bg-[url('~@/assets/images/topbar.png')] bg-no-repeat"></div>
      {topList.map((item) => {
        return item.href ? (
          <a
